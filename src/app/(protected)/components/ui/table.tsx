...
export default function ProfessionalTable<T extends Record<string, unknown>>({
  ...
  return (
    <TooltipProvider>
      <div className="relative h-[400px] overflow-hidden border rounded-lg">
        {/* Scrollable body wrapper */}
        <div className="h-full overflow-auto">
          <table className="min-w-full border-collapse table-fixed">
            {/* Header */}
            <thead className="sticky top-0 z-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
              <tr>
            ...
            {/* Footer */}
            <tfoot className="sticky bottom-0 z-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
              <tr>
                <td
